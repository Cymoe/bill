  ...
  return (
    ...
    <IndustryContext.Provider value={{ selectedIndustry, setSelectedIndustry }}>
      <div className="min-h-screen bg-[#121212]">
        ...
        {/* Main Content Area */}
        <div className={`${isSidebarCollapsed ? 'md:ml-14' : 'md:ml-48'} transition-all duration-300`}>
            {!isSidebarCollapsed && (
              <button 
          ...
          <div className={`${isSidebarCollapsed ? 'px-1 py-2' : 'px-2 py-2'} border-b border-[#333333] relative`}>
            <div className={`w-full ${isSidebarCollapsed ? 'space-y-2' : 'space-y-1'}`}>
              ...
              >
                <div className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : ''}`}>
                  <div className="w-6 h-6 rounded-full border border-[#9E9E9E] flex items-center justify-center">
