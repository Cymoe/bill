            ...
            <LayoutContext.Provider value={{ 
              ...
              <div className="min-h-screen bg-[#121212] flex overflow-x-hidden">
                  ...
                  <div className="hidden md:grid w-full h-screen overflow-hidden" 
                    style={{
                      gridTemplateColumns: `48px ${isChatPanelOpen ? `${chatPanelWidth}px` : '0px'} minmax(400px, 1fr) ${(isProjectsSidebarLocked || isProjectsSidebarOpen) && !isProjectsSidebarClosing ? '320px' : '0px'} ${isSidebarCollapsed ? '48px' : '192px'}`,
